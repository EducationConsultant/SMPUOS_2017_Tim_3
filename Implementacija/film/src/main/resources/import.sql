...
insert into film (film_id, brojac, datum_premijere, naziv, ocena, opis, prosecna_ocena, suma_ocena, trajanje, jezik_id, kategorija_id, reditelj_id ) values (4, 0, STR_TO_DATE('01-01-2018 00:00:00','%m-%d-%Y %H:%i:%s'), 'Film3', 0, 'Film3 opis', 0, 0, 30, 1, 1, 1);
insert into film (film_id, brojac, datum_premijere, naziv, ocena, opis, prosecna_ocena, suma_ocena, trajanje, jezik_id, kategorija_id, reditelj_id ) values (5, 0, STR_TO_DATE('01-01-2018 00:00:00','%m-%d-%Y %H:%i:%s'), 'Film3', 0, 'Film3 opis', 0, 0, 30, 1, 1, 1);
insert into film (film_id, brojac, datum_premijere, naziv, ocena, opis, prosecna_ocena, suma_ocena, trajanje, jezik_id, kategorija_id, reditelj_id ) values (6, 0, STR_TO_DATE('01-01-2018 00:00:00','%m-%d-%Y %H:%i:%s'), 'Film3', 0, 'Film3 opis', 0, 0, 30, 1, 1, 1);
insert into film (film_id, brojac, datum_premijere, naziv, ocena, opis, prosecna_ocena, suma_ocena, trajanje, jezik_id, kategorija_id, reditelj_id ) values (7, 0, STR_TO_DATE('01-01-2018 00:00:00','%m-%d-%Y %H:%i:%s'), 'Film3', 0, 'Film3 opis', 0, 0, 30, 1, 1, 1);
